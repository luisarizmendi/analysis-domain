...
public class ProcessTicket {
    ...
    public ProcessTicket(String orderId, String lineItemId, String item, String name, Instant timestamp, String madeBy) {
    ...
    public String toString() {
        return new StringJoiner(", ", ProcessTicket.class.getSimpleName() + "[", "]")
                .add("orderId='" + orderId + "'")
    ...
    public boolean equals(Object o) {
        ...
        ProcessTicket ticketUp = (ProcessTicket) o;
